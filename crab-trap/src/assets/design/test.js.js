...
export default function test.js(props) {
  return (
    <svg viewBox="0 0 72 36" version="1.1" style={{fillRule: 'evenodd', clipRule: 'evenodd', strokeLinecap: 'square', strokeMiterlimit: '1.5'}} width={72} height={36} {...props}>
      <rect x={0} y={0} width={72} height="35.189" style={{fill: 'none'}} />
      <g>
        <g className="shell">
          <path className="outer-shell" d="M16.268,16.734l7.73,-8.8l24.001,0l7.733,8.8l-9.357,13.2l-20.752,0l-9.355,-13.2Z" style={{fill: 'url(#_Linear1)', stroke: '#8d4a00', strokeWidth: '0.22px'}} />
        ...
        <g className="mouth">
          ...
          <g className="outer-mouth">
            <path className="right-mouth" d="M36,15.832l0,-2.718l-1.468,-1.21l-1.47,1.21l1.291,2.719" style={{fill: 'url(#_Linear6)', stroke: '#8d4a00', strokeWidth: '0.22px', strokeLinecap: 'round'}} />
            <path className="left-mouth" d="M36,15.832l0,-2.718l1.468,-1.21l1.47,1.21l-1.291,2.719" style={{fill: 'url(#_Linear7)', stroke: '#8d4a00', strokeWidth: '0.22px', strokeLinecap: 'round'}} />
          </g>
        </g>
        <g className="eyes">
          <g className="right-eye">
            <path d="M28.58,9.968l-0.008,-2.77c-0.332,-0.155 -0.568,-0.549 -0.569,-1.011c-0.002,-0.598 0.391,-1.085 0.876,-1.086c0.486,-0.001 0.882,0.483 0.884,1.081c0.001,0.462 -0.233,0.857 -0.564,1.014l0.008,2.773" style={{fill: 'url(#_Linear8)', stroke: '#8d4a00', strokeWidth: '0.22px', strokeLinecap: 'round'}} />
          ...
          <g className="left-eye">
            <path d="M43.42,9.96l0.008,-2.77c0.331,-0.155 0.568,-0.549 0.569,-1.011c0.002,-0.598 -0.391,-1.084 -0.877,-1.086c-0.486,-0.001 -0.881,0.483 -0.883,1.081c-0.001,0.462 0.233,0.858 0.564,1.014l-0.008,2.773" style={{fill: 'url(#_Linear9)', stroke: '#8d4a00', strokeWidth: '0.22px', strokeLinecap: 'round'}} />
        ...
        <g className="legs">
          <g className="left-legs">
            <g className="fourth-leg">
              <g>
                <path d="M39.668,29.902l-0.333,-0.53c0,0 0.197,-2.131 7.401,-4.702c-0.187,0.121 -0.303,0.334 -0.288,0.567c0.021,0.348 0.326,0.61 0.681,0.587c0.031,-0.002 0.061,-0.006 0.09,-0.013l0,0.002c0,0 -7.075,4.471 -7.551,4.089Z" style={{fill: 'url(#_Linear10)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                <g className="second-part">
                  <path d="M47.262,24.583c3.773,-0.031 8.1,4.037 8.1,4.037l-0.703,0.8c-7.238,-3.211 -7.393,-3.599 -7.396,-3.614c0.285,-0.07 0.493,-0.327 0.486,-0.627c-0.007,-0.29 -0.212,-0.529 -0.487,-0.596Z" style={{fill: 'url(#_Linear11)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <path d="M47,24.38c-0.459,0.059 -0.786,0.473 -0.729,0.923c0.058,0.451 0.477,0.768 0.937,0.708c0.46,-0.06 0.786,-0.474 0.729,-0.924c-0.058,-0.45 -0.478,-0.767 -0.937,-0.707Z" style={{fill: 'url(#_Linear12)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <g className="third-part">
                    <path d="M54.584,29.309c-0.001,0 -1.546,1.53 -0.994,2.656c0.438,0.896 1.512,1.031 2.192,0.378c0.896,-0.861 -0.133,-3.486 -0.133,-3.486" style={{fill: 'url(#_Linear13)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M55.363,28.494c-0.305,-0.163 -0.689,-0.052 -0.856,0.247c-0.166,0.3 -0.054,0.675 0.251,0.837c0.305,0.163 0.688,0.052 0.855,-0.247c0.167,-0.299 0.055,-0.674 -0.25,-0.837Z" style={{fill: 'url(#_Linear14)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                </g>
              </g>
              <circle cx="39.659" cy="28.825" r="1.109" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
              ...
              <g>
                ...
                <g className="second-part">
                  <g>
                    ...
                    <path d="M49.458,20.663c4.297,-0.035 9.224,4.408 9.224,4.408l-0.8,0.873c-8.243,-3.506 -8.421,-3.93 -8.424,-3.947c0.325,-0.077 0.562,-0.357 0.554,-0.684c-0.008,-0.317 -0.243,-0.578 -0.554,-0.65Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                  </g>
                  <g>
                    <clipPath id="_clip19">
                    ...
                    <path d="M49.26,20.435c-0.527,0.017 -0.944,0.432 -0.931,0.928c0.014,0.496 0.454,0.884 0.981,0.867c0.528,-0.017 0.945,-0.433 0.931,-0.928c-0.014,-0.496 -0.453,-0.884 -0.981,-0.867Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                  </g>
                  <g className="third-part">
                    <g>
                      <clipPath id="_clip21">
                      ...
                      <path d="M58.975,25.719c0.061,-0.168 -0.181,-0.539 -0.181,-0.539c0,0 3.275,3.372 0.967,8.604c0.378,-5.737 -1.726,-7.652 -1.726,-7.652l0.025,-0.025c0.02,0.008 0.04,0.015 0.061,0.022c0.351,0.107 0.734,-0.077 0.854,-0.41Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                    </g>
                    <g>
                      <clipPath id="_clip23">
                      ...
                      <path d="M58.805,25.02c-0.301,-0.247 -0.754,-0.221 -1.011,0.058c-0.257,0.279 -0.222,0.705 0.079,0.953c0.301,0.247 0.754,0.221 1.011,-0.058c0.256,-0.279 0.221,-0.706 -0.079,-0.953Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                    </g>
                  </g>
                </g>
              </g>
              <circle cx="40.059" cy="26.701" r="1.254" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
              ...
              <g>
                ...
                <g className="second-part">
                  <g>
                    ...
                    <path d="M50.35,17.687c4.548,-0.038 9.763,4.829 9.763,4.829l-0.847,0.957c-8.724,-3.841 -8.912,-4.305 -8.916,-4.323c0.344,-0.085 0.596,-0.391 0.587,-0.75c-0.008,-0.347 -0.257,-0.634 -0.587,-0.713Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                  </g>
                  <g>
                    <clipPath id="_clip27">
                    ...
                    <path d="M50.141,17.438c-0.558,0.018 -1,0.474 -0.985,1.017c0.015,0.543 0.479,0.968 1.038,0.95c0.558,-0.019 1,-0.474 0.985,-1.017c-0.014,-0.543 -0.48,-0.969 -1.038,-0.95Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                  </g>
                  <g className="third-part">
                    <g>
                      <clipPath id="_clip29">
                      ...
                      <path d="M60.423,23.227c0.064,-0.185 -0.191,-0.591 -0.191,-0.591c0,0 3.466,3.694 1.022,9.426c0.401,-6.285 -1.825,-8.383 -1.825,-8.383l0.026,-0.027c0.021,0.009 0.042,0.017 0.064,0.024c0.372,0.117 0.777,-0.085 0.904,-0.449Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                    </g>
                    <g>
                      <clipPath id="_clip31">
                      ...
                      <path d="M60.243,22.461c-0.318,-0.271 -0.797,-0.242 -1.07,0.063c-0.272,0.306 -0.235,0.773 0.084,1.044c0.318,0.271 0.797,0.243 1.069,-0.063c0.272,-0.305 0.235,-0.774 -0.083,-1.044Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                    </g>
                  </g>
                </g>
              </g>
              <circle cx="40.406" cy="24.245" r="1.442" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
            <g className="first-leg">
              <g>
                <path d="M41.31,21.235l0,-0.649c0,0 0.272,-2.879 10.265,-6.352c-0.259,0.164 -0.422,0.451 -0.401,0.766c0.03,0.47 0.454,0.824 0.946,0.792c0.042,-0.002 0.084,-0.008 0.125,-0.016l0,0.002c0,0 -10.757,7.861 -11.415,7.344c0,0 0.285,-0.298 0.231,-1.136c-0.034,-0.531 0.668,-0.465 0.249,-0.751Z" style={{fill: 'url(#_Linear32)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                <g className="second-part">
                  <path d="M52.305,14.117c5.232,-0.043 11.233,5.453 11.233,5.453l-0.974,1.081c-10.039,-4.338 -10.255,-4.863 -10.259,-4.883c0.396,-0.095 0.685,-0.442 0.675,-0.847c-0.009,-0.392 -0.296,-0.715 -0.675,-0.804Z" style={{fill: 'url(#_Linear33)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <path d="M52.065,13.835c-0.643,0.021 -1.151,0.535 -1.134,1.149c0.017,0.612 0.552,1.093 1.194,1.072c0.642,-0.021 1.151,-0.535 1.134,-1.148c-0.017,-0.614 -0.552,-1.094 -1.194,-1.073Z" style={{fill: 'url(#_Linear34)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <g className="third-part">
                    <path d="M63.895,20.372c0.074,-0.208 -0.22,-0.666 -0.22,-0.666c0,0 3.988,4.17 1.176,10.644c0.461,-7.098 -2.1,-9.467 -2.1,-9.467l0.03,-0.031c0.024,0.01 0.048,0.019 0.074,0.027c0.427,0.132 0.894,-0.095 1.04,-0.507Z" style={{fill: 'url(#_Linear35)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M63.687,19.508c-0.366,-0.306 -0.917,-0.274 -1.23,0.071c-0.313,0.345 -0.27,0.873 0.096,1.179c0.366,0.305 0.918,0.274 1.23,-0.071c0.313,-0.345 0.27,-0.874 -0.096,-1.179Z" style={{fill: 'url(#_Linear36)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                </g>
              </g>
              <circle cx="40.832" cy="21.586" r="1.558" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
          </g>
          <g className="right-legs">
            <g className="fourth-leg">
              <g>
                <path d="M32.332,29.902l0.333,-0.53c0,0 -0.197,-2.131 -7.401,-4.702c0.186,0.121 0.303,0.334 0.288,0.567c-0.021,0.348 -0.327,0.61 -0.681,0.587c-0.031,-0.002 -0.061,-0.006 -0.09,-0.013l0,0.002c0,0 7.075,4.471 7.551,4.089Z" style={{fill: 'url(#_Linear37)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                <g className="second-part">
                  <path d="M24.738,24.583c-3.773,-0.031 -8.1,4.037 -8.1,4.037l0.703,0.8c7.238,-3.211 7.393,-3.599 7.396,-3.614c-0.285,-0.07 -0.493,-0.327 -0.487,-0.627c0.008,-0.29 0.213,-0.529 0.488,-0.596Z" style={{fill: 'url(#_Linear38)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <path d="M25,24.38c0.459,0.059 0.786,0.473 0.729,0.923c-0.058,0.451 -0.477,0.768 -0.937,0.708c-0.46,-0.06 -0.786,-0.474 -0.729,-0.924c0.058,-0.45 0.478,-0.767 0.937,-0.707Z" style={{fill: 'url(#_Linear39)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <g className="third-part">
                    <path d="M17.416,29.309c0,0 1.546,1.53 0.994,2.656c-0.439,0.896 -1.512,1.031 -2.192,0.378c-0.896,-0.861 0.133,-3.486 0.133,-3.486" style={{fill: 'url(#_Linear40)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M16.637,28.494c0.305,-0.163 0.689,-0.052 0.856,0.247c0.166,0.3 0.054,0.675 -0.251,0.837c-0.305,0.163 -0.688,0.052 -0.855,-0.247c-0.167,-0.299 -0.055,-0.674 0.25,-0.837Z" style={{fill: 'url(#_Linear41)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                </g>
              </g>
              <circle cx="32.341" cy="28.825" r="1.109" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
            <g className="third-leg">
              <g>
                <g>
                ...
                <g className="second-part">
                  <g>
                    ...
                    <path d="M22.542,20.663c-4.297,-0.035 -9.224,4.408 -9.224,4.408l0.8,0.873c8.243,-3.506 8.421,-3.93 8.424,-3.947c-0.325,-0.077 -0.562,-0.357 -0.554,-0.684c0.008,-0.317 0.243,-0.578 0.554,-0.65Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                  </g>
                  <g>
                    <clipPath id="_clip46">
                    ...
                    <path d="M22.74,20.435c0.527,0.017 0.944,0.432 0.931,0.928c-0.014,0.496 -0.454,0.884 -0.981,0.867c-0.528,-0.017 -0.945,-0.433 -0.931,-0.928c0.014,-0.496 0.453,-0.884 0.981,-0.867Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                  </g>
                  <g className="third-part">
                    <g>
                      <clipPath id="_clip48">
                      ...
                      <path d="M13.025,25.719c-0.061,-0.168 0.181,-0.539 0.181,-0.539c0,0 -3.275,3.372 -0.967,8.604c-0.378,-5.737 1.726,-7.652 1.726,-7.652l-0.025,-0.025c-0.02,0.008 -0.04,0.015 -0.061,0.022c-0.351,0.107 -0.734,-0.077 -0.854,-0.41Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                    </g>
                    <g>
                      <clipPath id="_clip50">
                      ...
                      <path d="M13.195,25.02c0.301,-0.247 0.754,-0.221 1.011,0.058c0.257,0.279 0.222,0.705 -0.079,0.953c-0.301,0.247 -0.754,0.221 -1.011,-0.058c-0.256,-0.279 -0.221,-0.706 0.079,-0.953Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.09px', strokeLinecap: 'round'}} />
                    </g>
                  </g>
                </g>
              </g>
              <circle cx="31.941" cy="26.701" r="1.254" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
            <g className="second-leg">
              <g>
                <g>
                ...
                <g className="second-part">
                  <g>
                    ...
                    <path d="M21.65,17.687c-4.548,-0.038 -9.763,4.829 -9.763,4.829l0.847,0.957c8.724,-3.841 8.912,-4.305 8.916,-4.323c-0.344,-0.085 -0.596,-0.391 -0.587,-0.75c0.008,-0.347 0.257,-0.634 0.587,-0.713Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                  </g>
                  <g>
                    <clipPath id="_clip54">
                    ...
                    <path d="M21.859,17.438c0.558,0.018 1,0.474 0.985,1.017c-0.015,0.543 -0.479,0.968 -1.038,0.95c-0.558,-0.019 -1,-0.474 -0.985,-1.017c0.014,-0.543 0.48,-0.969 1.038,-0.95Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                  </g>
                  <g className="third-part">
                    <g>
                      <clipPath id="_clip56">
                      ...
                      <path d="M11.577,23.227c-0.064,-0.185 0.191,-0.591 0.191,-0.591c0,0 -3.466,3.694 -1.022,9.426c-0.401,-6.285 1.825,-8.383 1.825,-8.383l-0.026,-0.027c-0.021,0.009 -0.042,0.017 -0.064,0.024c-0.372,0.117 -0.777,-0.085 -0.904,-0.449Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                    </g>
                    <g>
                      <clipPath id="_clip58">
                      ...
                      <path d="M11.757,22.461c0.318,-0.271 0.797,-0.242 1.07,0.063c0.272,0.306 0.235,0.773 -0.084,1.044c-0.318,0.271 -0.797,0.243 -1.069,-0.063c-0.272,-0.305 -0.235,-0.774 0.083,-1.044Z" style={{fill: 'none', stroke: '#8d4a00', strokeWidth: '0.1px', strokeLinecap: 'round'}} />
                    </g>
                  </g>
                </g>
              </g>
              <circle cx="31.594" cy="24.245" r="1.442" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
            <g className="first-leg">
              <g>
                <path d="M30.69,21.235l0,-0.649c0,0 -0.272,-2.879 -10.265,-6.352c0.259,0.164 0.422,0.451 0.401,0.766c-0.03,0.47 -0.454,0.824 -0.946,0.792c-0.042,-0.002 -0.084,-0.008 -0.125,-0.016l0,0.002c0,0 10.757,7.861 11.415,7.344c0,0 -0.285,-0.298 -0.231,-1.136c0.034,-0.531 -0.668,-0.465 -0.249,-0.751Z" style={{fill: 'url(#_Linear59)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                <g className="second-part">
                  <path d="M19.695,14.117c-5.232,-0.043 -11.233,5.453 -11.233,5.453l0.974,1.081c10.039,-4.338 10.255,-4.863 10.259,-4.883c-0.396,-0.095 -0.685,-0.442 -0.675,-0.847c0.009,-0.392 0.296,-0.715 0.675,-0.804Z" style={{fill: 'url(#_Linear60)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <path d="M19.935,13.835c0.643,0.021 1.151,0.535 1.134,1.149c-0.017,0.612 -0.552,1.093 -1.194,1.072c-0.642,-0.021 -1.151,-0.535 -1.134,-1.148c0.017,-0.614 0.552,-1.094 1.194,-1.073Z" style={{fill: 'url(#_Linear61)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  <g className="third-part">
                    <path d="M8.105,20.372c-0.074,-0.208 0.22,-0.666 0.22,-0.666c0,0 -3.988,4.17 -1.176,10.644c-0.461,-7.098 2.1,-9.467 2.1,-9.467l-0.03,-0.031c-0.024,0.01 -0.048,0.019 -0.074,0.027c-0.427,0.132 -0.894,-0.095 -1.04,-0.507Z" style={{fill: 'url(#_Linear62)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M8.313,19.508c0.366,-0.306 0.917,-0.274 1.23,0.071c0.313,0.345 0.27,0.873 -0.096,1.179c-0.366,0.305 -0.918,0.274 -1.23,-0.071c-0.313,-0.345 -0.27,-0.874 0.096,-1.179Z" style={{fill: 'url(#_Linear63)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                </g>
              </g>
              <circle cx="31.168" cy="21.586" r="1.558" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            </g>
          </g>
        </g>
        <g className="pincers">
          <g className="left-pincer">
            <path d="M40.346,17.229c-0.001,0 0.544,-2.023 3.7,-2.779c0.012,-0.003 1.731,1.377 1.731,1.377c0,0 -0.225,1.869 -3.791,4.087c-0.008,0.006 -1.641,-2.685 -1.641,-2.685Z" style={{fill: 'url(#_Linear64)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            <circle cx="39.876" cy="19.314" r="2.246" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            <g className="second-part">
              <path d="M47.717,11.761c0,0 0.02,2.887 -1.888,3.883c-0.01,0.005 -2.086,-0.809 -2.086,-0.809c0,0 0.258,-2.764 2.312,-3.521c0.013,-0.004 1.662,0.447 1.662,0.447Z" style={{fill: 'url(#_Linear65)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
              <circle cx="44.729" cy="15.21" r="1.221" style={{fill: 'url(#_Linear66)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
              <g className="third-part">
                <g>
                  <g>
                    <path d="M48.044,11.371c0,0 2.362,-2.834 2.418,-4.278c0.018,-0.459 -2.185,-0.455 -2.638,-1.389c-0.256,-0.529 0.291,-0.803 0.087,-1.131c-0.194,-0.312 -0.469,-0.402 -0.582,-0.629c-0.228,-0.46 0.044,-0.721 -0.072,-0.806c-0.116,-0.085 -0.519,0.157 -0.689,0.5c-0.169,0.344 -0.3,1.154 -0.334,2.15c-0.036,0.997 -0.25,3.131 -0.364,3.763c-0.114,0.633 -0.118,1.224 0.108,1.397c0.013,0.01 2.065,0.423 2.065,0.423Z" style={{fill: 'url(#_Linear67)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M48.044,11.37c0,0 2.362,-2.833 2.418,-4.277c0.018,-0.459 -2.185,-0.455 -2.638,-1.389c-0.256,-0.529 0.291,-0.803 0.087,-1.13c-0.194,-0.313 -0.469,-0.403 -0.582,-0.63c-0.228,-0.46 0.044,-0.721 -0.072,-0.806c-0.116,-0.085 -0.519,0.157 -0.689,0.5c-0.169,0.344 -0.3,1.154 -0.334,2.15c-0.036,0.997 -0.25,3.131 -0.364,3.763c-0.114,0.632 -0.118,1.224 0.108,1.397c0.013,0.01 2.065,0.422 2.065,0.422Z" style={{fill: 'url(#_Linear68)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                  <g className="moving-pincer">
                    <path d="M49.559,2.946c0.013,-0.123 1.297,-0.233 1.547,1.4c0.25,1.634 -0.633,2.587 -0.633,2.587l-1.682,-0.504c0,0 0.308,-0.383 0.273,-0.783c-0.02,-0.239 0.106,-0.77 0.198,-0.848c0.11,-0.093 0.503,0.05 0.601,-0.127c0.098,-0.176 -0.034,-0.612 0.009,-0.766c0.044,-0.154 0.19,-0.339 0.097,-0.544c-0.094,-0.204 -0.424,-0.292 -0.41,-0.415Z" style={{fill: 'url(#_Linear69)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M50.558,6.511c0.112,0.504 -0.205,1.005 -0.708,1.118c-0.502,0.112 -1.001,-0.207 -1.113,-0.712c-0.111,-0.505 0.207,-1.006 0.709,-1.118c0.502,-0.112 1.001,0.207 1.112,0.712Z" style={{fill: 'url(#_Linear70)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                </g>
                <ellipse cx="46.822" cy="11.358" rx="1.21" ry="1.152" style={{fill: 'url(#_Linear71)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
              </g>
            </g>
          </g>
          <g className="right-pincer">
            <path d="M32.157,17.142c0,0 -0.618,-2.296 -4.199,-3.154c-0.013,-0.004 -1.963,1.563 -1.963,1.563c0,0 0.255,2.12 4.3,4.638c0.01,0.006 1.862,-3.047 1.862,-3.047Z" style={{fill: 'url(#_Linear72)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            <circle cx="32.253" cy="19.311" r="2.246" style={{fill: '#ffd175', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
            <g className="second-part">
              <path d="M23.793,10.937c0,0 -0.022,3.275 2.142,4.406c0.012,0.006 2.367,-0.918 2.367,-0.918c0,0 -0.293,-3.136 -2.624,-3.994c-0.014,-0.006 -1.885,0.506 -1.885,0.506Z" style={{fill: 'url(#_Linear73)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
              <circle cx="27.184" cy="14.85" r="1.386" style={{fill: 'url(#_Linear74)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
              <g className="third-part">
                <g>
                  <g>
                    <path d="M23.423,10.494c0,0 -2.681,-3.215 -2.745,-4.852c-0.02,-0.523 2.48,-0.517 2.994,-1.577c0.291,-0.601 -0.33,-0.912 -0.1,-1.282c0.221,-0.355 0.534,-0.458 0.661,-0.715c0.258,-0.523 -0.049,-0.818 0.082,-0.915c0.132,-0.096 0.59,0.178 0.782,0.568c0.192,0.39 0.34,1.31 0.38,2.44c0.04,1.13 0.283,3.551 0.412,4.269c0.129,0.717 0.134,1.388 -0.122,1.585c-0.015,0.011 -2.344,0.479 -2.344,0.479Z" style={{fill: 'url(#_Linear75)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M23.423,10.494c-0.001,0 -2.681,-3.215 -2.745,-4.852c-0.02,-0.523 2.48,-0.517 2.994,-1.577c0.291,-0.601 -0.33,-0.912 -0.1,-1.282c0.221,-0.355 0.534,-0.458 0.661,-0.715c0.258,-0.523 -0.049,-0.818 0.082,-0.915c0.132,-0.096 0.59,0.178 0.782,0.568c0.192,0.39 0.34,1.31 0.38,2.44c0.04,1.13 0.283,3.551 0.412,4.269c0.129,0.717 0.134,1.388 -0.122,1.585c-0.015,0.011 -2.345,0.479 -2.345,0.479Z" style={{fill: 'url(#_Linear76)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                  <g className="moving-pincer">
                    <path d="M21.703,0.935c-0.015,-0.14 -1.472,-0.264 -1.755,1.59c-0.284,1.852 0.718,2.934 0.718,2.934l1.908,-0.572c0,0 -0.349,-0.434 -0.31,-0.889c0.024,-0.27 -0.12,-0.874 -0.224,-0.962c-0.124,-0.106 -0.57,0.057 -0.682,-0.143c-0.111,-0.201 0.039,-0.695 -0.01,-0.87c-0.05,-0.174 -0.215,-0.384 -0.11,-0.617c0.106,-0.232 0.481,-0.331 0.465,-0.471Z" style={{fill: 'url(#_Linear77)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                    <path d="M20.564,4.973c-0.127,0.573 0.233,1.142 0.804,1.269c0.57,0.128 1.136,-0.234 1.262,-0.808c0.127,-0.572 -0.233,-1.141 -0.803,-1.268c-0.57,-0.127 -1.137,0.234 -1.263,0.807Z" style={{fill: 'url(#_Linear78)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
                  </g>
                </g>
                <ellipse cx="24.826" cy="10.476" rx="1.372" ry="1.307" style={{fill: 'url(#_Linear79)', stroke: '#8d4a00', strokeWidth: '0.11px', strokeLinecap: 'round'}} />
              </g>
            </g>
          </g>
        </g>
