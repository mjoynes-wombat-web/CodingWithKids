...
const CrabSVG = ({ className, removePincerAction }) => (
  <svg className={className} viewBox="0 0 72 36" version="1.1" style={{fillRule: 'evenodd', clipRule: 'evenodd', strokeLinecap: 'square', strokeMiterlimit: '1.5'}} width={72} height={36}>
