...
var index_App = function (_Component) {
	...
	function App(props) {
		...
		_this.movePincers = _this.movePincers.bind(_this);
		_this.walk = _this.walk.bind(_this);
		_this.stopWalking = _this.stopWalking.bind(_this);
		return _this;
	}

	App.prototype.movePincers = function movePincers() {
	...
	App.prototype.stopWalking = function stopWalking() {
	...
	App.prototype.render = function render() {
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				'button',
				{ onClick: this.movePincers },
				'Change Pincer Movement'
			),
			Object(preact_min["h"])(
				'button',
				{ onClick: this.walk },
