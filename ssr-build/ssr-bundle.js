...
var index_App = function (_Component) {
	...
	function App(props) {
		...
		_this.setPincerAction = _this.setPincerAction.bind(_this);
		_this.walk = _this.walk.bind(_this);
		_this.stopWalking = _this.stopWalking.bind(_this);
		return _this;
	}

	App.prototype.setPincerAction = function setPincerAction(e) {
		e.preventDefault();
	...
	App.prototype.walk = function walk(e) {
		...
		this.setState({ walk: true, direction: direction });
	};

	App.prototype.stopWalking = function stopWalking(e) {
		e.preventDefault();
	...
	App.prototype.render = function render() {
		return Object(preact_min["h"])(
			'main',
			null,
			Object(preact_min["h"])(crab, { walk: this.state.walk, pincerAction: this.state.pincerAction, direction: this.state.direction }),
			Object(preact_min["h"])(
				'form',
				null,
				Object(preact_min["h"])(
				...
				this.state.walk ? Object(preact_min["h"])(
					'button',
...
CrabFinal.defaultProps = {"width":"100%","height":"100%","viewBox":"0 0 96 47","version":"1.1","xmlSpace":"preserve","xmlnsSerif":"http://www.serif.com/","style":{"fillRule":"evenodd","clipRule":"evenodd","strokeLinecap":"square","strokeMiterlimit":"1.5"}};
