...
var _ref2 = Object(preact_min["h"])(react_fontawesome_index_es, { icon: faCompress_default.a });

var _ref3 = Object(preact_min["h"])(react_fontawesome_index_es, { icon: faExpand_default.a });

var _ref4 = Object(preact_min["h"])(react_fontawesome_index_es, { icon: faWalking_default.a });
...
var index_App = function (_Component) {
	...
	App.prototype.initGame = function initGame() {
		...
		var cols = Math.floor(window.innerWidth / Math.max(shellDimensions.width * Math.round(5 - this.state.difficulty / 1.75), shellDimensions.width * 2));
		var rows = Math.floor(window.innerHeight / Math.max(shellDimensions.height * Math.round(6 - this.state.difficulty / 1.75), shellDimensions.height * 4));
	...
	App.prototype.setHidable = function setHidable(spots) {
		...
		var minPercent = 0.5 * Math.max(this.state.difficulty * 0.33, 1);
		var maxPercent = 0.66 * Math.max(this.state.difficulty * 0.33, 1);
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					...
					this.state.fullscreen ? _ref2 : _ref3
				),
				this.state.fullscreen ? Object(preact_min["h"])(
					'button',
					{
